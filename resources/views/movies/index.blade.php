...
<div id="highlight" >
    <div id="highlight-item" >
        ...
        <div class="leftbox">
           <img @if($production_companies['logo_path']) src="http://image.tmdb.org/t/p/w500{{$production_companies['logo_path']}}" @else src="https://www.freepnglogos.com/uploads/netflix-logo-0.png" @endif id="netflix-logo"> <h1 id="h-main">  {{$movie['title']}} </h1>
           <div id="highlight-content" >
            <p id="content"> {{$movie['overview']}} </p><br>
           <a href="{{ url('/movies/'.$production_companies['id'])}}"><button id="myBtn">Learn More</button> </a>   
...
<div class="featured">
    ...
    <div class="featured-text"><p><b><i>{{$random['title']}}</b></i>: {{$random['overview']}}
    </p>
    <a href="{{ url('/movies/'.$random['id'])}}">
